...
fun SunsetSunRiseRow(weather: WeatherItem) {
    Row(modifier = Modifier
        ...
        verticalAlignment = Alignment.CenterVertically) {
        Row {
            Image(painter = painterResource(id = com.example.myweatherforecast.R.drawable.sunrise),
        ...
        Row {
            ...
            Text(text = formatDateTime(weather.sunset),
                style = MaterialTheme.typography.caption)
            Image(painter = painterResource(id = com.example.myweatherforecast.R.drawable.sunset),
...
fun HumidityWindPressureRow(weather: WeatherItem,
    ...
    Row(modifier = Modifier
        ...
        Row(modifier = Modifier.padding(4.dp)) {
            Icon(painter = painterResource(id = com.example.myweatherforecast.R.drawable.humidity),
        ...
        Row() {
            Icon(painter = painterResource(id = com.example.myweatherforecast.R.drawable.pressure),
        ...
        Row() {
            Icon(painter = painterResource(id = com.example.myweatherforecast.R.drawable.wind),
